// PrintingMachineFilter.jsx
import Button from "../button/Button";

export default function PrintingMachineFilter({ value = [], onChange }) {
  const options = [
  ...
  return (
    <div>
      <h3 className="mb-3 text-sm font-semibold text-gray-800">Printing Machine</h3>
