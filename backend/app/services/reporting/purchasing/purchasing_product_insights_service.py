...
class PurchasingProductInsightsService(BaseReportService):
    ...
    #     total_value = func.sum(PurchasingDetail.quantity * PurchasingDetail.price + PurchasingDetail.quantity * PurchasingDetail.ppn)
    #     total_qty = func.sum(PurchasingDetail.quantity)

    #     q = (
    #         db.query(
    #             Product.name.label("product"),
    #             func.sum(PurchasingDetail.quantity * PurchasingDetail.price + PurchasingDetail.quantity * PurchasingDetail.ppn / PurchasingDetail.quantity).label("avg_unit_cost"),
    #         )
    #         .join(Purchasing, Purchasing.id == PurchasingDetail.purchasing_id)
    #         .group_by(Product.name)
    #         .order_by(func.sum(PurchasingDetail.quantity * PurchasingDetail.price + PurchasingDetail.quantity * PurchasingDetail.ppn / PurchasingDetail.quantity).desc())
